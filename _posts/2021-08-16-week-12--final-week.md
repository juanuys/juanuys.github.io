...
Here we are in the final week of [GDD730](https://falmouth.akarisoftware.com/index.cfm/page/module/moduleId/93154), where the ultimate aim was

{% quote falmouth_falmouth_nodate %}
To cultivate ways of collaborating and managing creative projects effectively in a distributed multidisciplinary context.
{% endquote %}

# Our product

The [10-minute pitch](https://www.youtube.com/watch?v=-GIG6-YPvyU):

<iframe width="1250" height="703" src="https://www.youtube.com/embed/-GIG6-YPvyU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


The [3-minute demo](https://youtu.be/1ITDmPWtRkQ):

<iframe width="1250" height="703" src="https://www.youtube.com/embed/1ITDmPWtRkQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

A selection of docs can be found on our [Drive](https://drive.google.com/drive/folders/17eOdX3PcrI7qKx4u62VsecjxRSho0nXS).

Some highlights: 
- [the pitch](https://docs.google.com/presentation/d/1mNkD2FtJvG0cgwv-lEZ1tzkSjqDXQhJyb4ZyLbZLbKg/edit?usp=sharing)
- [the pitch planning](https://docs.google.com/document/d/1KOmctGOC1-fVxfJRZLwjmLqVvad8kBEZf20xrI2msfc/edit?usp=sharing)
- [team charter](https://docs.google.com/document/d/1ixame1WWwtvBAIOxSUPhcevvTkdE_amxRvhGPPKzrHI/edit?usp=sharing)
...
For example, I focused on the Twine prototype, and didn't <span title="In fact, no-one ended up doing any Unity *tsk tsk*">get involved at all in the Unity aspect of it</span>, or Josh/Luis discussed the UX/research work amongst themselves, and it worked out well.

## We kept the scope small

I'm a big fan of the Essentialism mindset {% cite mckeown_essentialism_2014 %}, which helps one focus on what's important, and working backwards from a stated goal and only doing those critical things for its success. In the early stages of our project, there were a lot of big, wonderful ideas, but I made an effort to communicate to the team to apply the essentialism mindset. I also came up with various escape hatches in case we ran out of time, for example:
...
We initially thought to use Microsoft Teams  {% cite noauthor_microsoft_nodate %} for all our product collaboration needs, as it has all the tools in one place (task tracker, docs, text/video chat, scheduling). However, we soon found out that the task tracker add-on lacked a lot of features that we were used to coming from tools like Jira, Pivotal Tracker, Trello, etc.
...
We had a really good team, and I was proud to put us front-and-center on the pitch deck, where it belongs {% cite alejandro_i_cremades_how_nodate %}. Investors invest in teams, not ideas, after all.

# Did my team like the project?

Team members can sometimes be in love with a different idea of what the game would be like {% cite schell_art_2019 -l 461 %}. I was aware of this pitfall early, which is why I tried to make it clear in the very beginning what the game/product was going to be.

I think in the end <span title="Save for the Unity guy, maybe!">everyone liked what we made<span>, and was massively proud of it.

# As team-work worth it in the end?

Game design and development are hard. Unless you are multitalented and your project is tiny, you can't do it alone {% cite schell_art_2019 -l 468 %}. People are more important than ideas, because, in the words of Pixar's Ed Catmull

{% quote stanford_graduate_school_of_business_ed_nodate %}
...
In the book by Jesse Schell which I cited before, he recommends reading about [Valve Software's Cabal](https://www.gamasutra.com/view/feature/131815/the_cabal_valves_design_process_.php?page=2):

{% quote birdwell_cabal_1999 -l 2 %}
...
The Bhagavad Gita, a Hindu holy scripture says that <span class="highlight">a person who is happy has achieved the self</span> {% cite davis_bhagavad_2015 %}.
